    ...
    <section class="top-flow">
        <div class="container">
            ...
            <div class="top-flow_step">
                <div class="flex top-flow_step--flex">

                    <div class="top-flow_item">
                        <div class="flex top-flow_item--flex">
                            <div class="top-flow_item--nums">
            ...
            <div class="top-flow_detailItems">
                ...
                <div class="top-flow_detailItem" id="01">
                    ...
                    <div class="flex top-flow_detail--stepFlex">
                        ...
                        <p class="top-flow_detail--num">01</p>
                    ...
                    <div class="flex flex-column top-flow_detailItemFlex">
                        ...
                        <div class="top-flow_detailItemRight">
                            <div class="top-flow_detailItem--example">
                                ...
                                <ul class="top-flow_detailItem--exampleLists">
                                    <li class="flex top-flow_detailItem--exampleList">
                                        <span class="top-flow_detail--exampleListNum">01</span>
                                        <p class="top-flow_detail--exampleListText">仕事と家庭のバランスを大事にしたい
                                        </p>
                                    </li>
                                    <li class="flex top-flow_detailItem--exampleList">
                                    ...
                                    <li class="flex top-flow_detailItem--exampleList">
                                        ...
                                        <p class="top-flow_detail--exampleListText">コミュニケーション力</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="top-flow_detailItem" id="05">
                    ...
                    <div class="flex top-flow_detail--stepFlex">
                        <span class="top-flow_detail--step">STEP</span>
                        <p class="top-flow_detail--num">05</p>
                        <p class="top-flow_detail--text">内定</p>
                    </div>

                    <div class="top-flow_detailItemTextBox">
                        <p class="top-flow_detailItemText">
                            無事に採用合格の通知がきたら、内定を受けるかどうかの意思決定を行います。<br>
                ...
                <div class="top-flow_detailItem" id="06">
                    ...
                    <div class="flex top-flow_detail--stepFlex">
                        <span class="top-flow_detail--step">STEP</span>
                        <p class="top-flow_detail--num">06</p>
                        <p class="top-flow_detail--text">退職手続き・退職</p>
                    </div>

                    <div class="top-flow_detailItemTextBox">
                        <p class="top-flow_detailItemText">
                            内定を承諾し転職する意思が固まれば、所属長に退職意思を伝えます。<br>
                            円満退職そして、新しい職場へ快く入職するためにも、<span>最後まで気を抜かず転職活動を行いましょう。</span>
                        </p>
                    </div>
